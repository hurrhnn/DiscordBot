...
public class LoopCommand implements ICmd {
    ...
    public void handle(CmdContext cmdContext) {
        ...
        cmdContext.getChannel().sendMessageEmbeds(EmbedUtils.embedMessageWithTitle("Music - Loop!", "The loop mode of the music player has been " + (musicManager.scheduler.isLoopQueue ? "activated." : "deactivated.")).build()).queue();
    }
